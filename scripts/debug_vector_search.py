...
async def main():
    ...
    for i, result in enumerate(results, 1):
        ...
        has_answer = (
            "pojazd" in result.content.lower() and
            "uszkodzenia" in result.content.lower() and
            "kradzież" in result.content.lower() and
            "all risks" in result.content.lower()
        )
    ...
    for i, chunk in enumerate(chunks):
        if ("pojazd" in chunk.content.lower() and
            "uszkodzenia" in chunk.content.lower() and
            "kradzież" in chunk.content.lower() and
            "all risks" in chunk.content.lower()):
