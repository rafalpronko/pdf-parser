...
class TestParsingModels:
    ...
    def test_parsed_document(self):
        ...
        doc = ParsedDocument(
            text_blocks=[
                TextBlock(content="Text", page=1, bbox=(0, 0, 100, 50))
            ],
            images=[],
            tables=[],
            num_pages=5,
...
class TestResponseSerializationProperties:
    ...
    @given(
        ...
        processing_time=st.floats(min_value=0.0, max_value=300.0, allow_nan=False, allow_infinity=False),
        num_sources=st.integers(min_value=0, max_value=20),
    )
    @settings(max_examples=100, deadline=None)
    def test_property_22_query_response_serialization(
        self, answer, processing_time, num_sources
    ):
        """Feature: pdf-rag-system, Property 22: Response serialization consistency.
    ...
    @settings(max_examples=100, deadline=None)
    def test_property_22_error_response_serialization(
        self, error, detail, request_id
    ):
        """Feature: pdf-rag-system, Property 22: Response serialization consistency.
    ...
    @settings(max_examples=100, deadline=None)
    def test_property_22_text_block_serialization(
        self, content, page, bbox_values
    ):
        """Feature: pdf-rag-system, Property 22: Response serialization consistency.
    ...
    @settings(max_examples=100, deadline=None)
    def test_property_22_parsed_document_nested_serialization(
        self, text_blocks, num_pages
    ):
        """Feature: pdf-rag-system, Property 22: Response serialization consistency.
